package com.example.alpha.HEALTH_TRACKER;
...
import com.example.alpha.HEALTH_TRACKER.Math.Fft;
...
public class BloodPressureProcess extends Activity {
    ...
    //we are using BloodPressure variables
    ...
    public int counter = 0;
     //we are connecting activity_blood_pressure_process to java
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            user = extras.getString("Usr"); //The key argument here must match that used in the other activity
        }
